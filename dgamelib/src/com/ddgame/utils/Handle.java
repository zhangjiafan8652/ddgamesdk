...
import com.ddgame.sdk.utils.CryptoUtil;
import com.ddgame.sdk.utils.RSACoder;
					...
					public void onSuccess(ResponseInfo<String> resz) {
						...
						try {
							...
							if (recode == 0) {
								...
								int center_status = data.optInt("center_status",0);
								Sputils.putSPint("login_type", webpay, context);//
								Sputils.putSPint("login_pay_level", level,
										context);
								Sputils.putSPint("center_status", center_status,
										context);
							}
